...
class AccountUpdateTransaction extends _Transaction.default {
  ...
  static _fromProtobuf(transactions, signedTransactions, transactionIds, nodeIds, bodies) {
    const body = bodies[0];
    const update = /** @type {HieroProto.proto.ICryptoUpdateTransactionBody} */
    body.cryptoUpdateAccount;
    return _Transaction.default._fromProtobufTransactions(new AccountUpdateTransaction({
      accountId: update.accountIDToUpdate != null ? _AccountId.default._fromProtobuf(/** @type {HieroProto.proto.IAccountID} */
      update.accountIDToUpdate) : undefined,
      key: update.key != null ? _Key.default._fromProtobufKey(update.key) : undefined,
      receiverSignatureRequired: update.receiverSigRequiredWrapper != null ? Object.hasOwn(update.receiverSigRequiredWrapper, "value") ? update.receiverSigRequiredWrapper.value : undefined : undefined,
      proxyAccountId: update.proxyAccountID != null ? _AccountId.default._fromProtobuf(/** @type {HieroProto.proto.IAccountID} */
      ...
      accountMemo: update.memo != null ? Object.hasOwn(update.memo, "value") ? update.memo.value : undefined : undefined,
      maxAutomaticTokenAssociations: update.maxAutomaticTokenAssociations != null && update.maxAutomaticTokenAssociations.value != null && Object.hasOwn(update.maxAutomaticTokenAssociations, "value") ? _long.default.fromNumber(update.maxAutomaticTokenAssociations.value) : undefined,
      stakedAccountId: update.stakedAccountId != null ? _AccountId.default._fromProtobuf(update.stakedAccountId) : undefined,
      stakedNodeId: update.stakedNodeId != null ? update.stakedNodeId : undefined,
      declineStakingReward: update.declineReward != null ? Object.hasOwn(update.declineReward, "value") ? update.declineReward.value : undefined : undefined
  ...
  clearStakedAccountId() {
    this._requireNotFrozen();
    this._stakedAccountId = new _AccountId.default(0, 0, 0);
    return this;
  }
  ...
  clearStakedNodeId() {
    this._requireNotFrozen();
    this._stakedNodeId = _long.default.fromNumber(-1);
    return this;
  }
...
_Transaction.TRANSACTION_REGISTRY.set("cryptoUpdateAccount",
