...
export default class AccountAllowanceApproveTransaction extends Transaction {
     ...
     */
    static _fromProtobuf(transactions: HieroProto.proto.ITransaction[], signedTransactions: HieroProto.proto.ISignedTransaction[], transactionIds: TransactionId[], nodeIds: AccountId[], bodies: HieroProto.proto.ITransactionBody[]): AccountAllowanceApproveTransaction;
    /**
     * @param {object} [props]
     ...
     */
    protected override _makeTransactionData(): HieroProto.proto.ICryptoApproveAllowanceTransactionBody;
}
export namespace HieroProto {
    namespace proto {
        ...
        type ICryptoApproveAllowanceTransactionBody = import("@hiero-ledger/proto").proto.ICryptoApproveAllowanceTransactionBody;
