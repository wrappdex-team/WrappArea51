...
export default class AccountAllowanceAdjustTransaction extends Transaction {
     ...
     * @returns {AccountAllowanceAdjustTransaction}
     */
    _adjustHbarAllowance(ownerAccountId: AccountId | string | null, spenderAccountId: AccountId | ContractId | string, amount: Hbar): AccountAllowanceAdjustTransaction;
    /**
     * @deprecated
     ...
     * @returns {AccountAllowanceAdjustTransaction}
     */
    _adjustTokenAllowance(tokenId: TokenId | string, ownerAccountId: AccountId | string | null, spenderAccountId: AccountId | ContractId | string, amount: Long | number): AccountAllowanceAdjustTransaction;
    /**
     * @deprecated
     * @param {TokenId | string} tokenId
     * @param {AccountId | string} ownerAccountId
     ...
     * @returns {AccountAllowanceAdjustTransaction}
     */
    _adjustTokenNftAllowance(nftId: NftId, ownerAccountId: AccountId | string | null, spenderAccountId: AccountId | ContractId | string): AccountAllowanceAdjustTransaction;
    /**
     * @deprecated
     * @param {NftId | string} nftId
     * @param {AccountId | string} ownerAccountId
     ...
     * @returns {AccountAllowanceAdjustTransaction}
     */
    _adjustTokenNftAllowanceAllSerials(tokenId: TokenId | string, ownerAccountId: AccountId | string | null, spenderAccountId: AccountId | ContractId | string, allSerials: boolean): AccountAllowanceAdjustTransaction;
}
