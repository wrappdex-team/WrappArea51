...
class TransactionReceiptQuery extends _Query.default {
  ...
  static _fromProtobuf(query) {
    const receipt = /** @type {HieroProto.proto.ITransactionGetReceiptQuery} */
  ...
  _shouldRetry(request, response) {
    ...
    const transactionGetReceipt = /** @type {HieroProto.proto.ITransactionGetReceiptResponse} */
    ...
    if (this._logger) {
      this._logger.debug(`[${this._getLogId()}] received receipt status ${status.toString()}`);
    }
    switch (status) {
      case _Status.default.Busy:
      case _Status.default.Unknown:
      ...
      case _Status.default.FeeScheduleFilePartUploaded:
  ...
  _mapResponseHeader(response) {
    const transactionGetReceipt = /** @type {HieroProto.proto.ITransactionGetReceiptResponse} */
    response.transactionGetReceipt;
    return /** @type {HieroProto.proto.IResponseHeader} */transactionGetReceipt.header;
  }
