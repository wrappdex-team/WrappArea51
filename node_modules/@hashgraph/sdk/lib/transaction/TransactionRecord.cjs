...
class TransactionRecord {
  ...
  _toProtobuf() {
    ...
    const duplicates = this.duplicates.map(record => (/** @type {HieroProto.proto.ITransactionRecord} */
    record._toProtobuf().transactionRecord));
    const children = this.children.map(record => (/** @type {HieroProto.proto.ITransactionRecord} */
    record._toProtobuf().transactionRecord));
    return {
      ...
      transactionRecord: {
        ...
        newPendingAirdrops: this.newPendingAirdrops.map(airdrop => airdrop.toBytes())
      }
    };
  }
  ...
  static _fromProtobuf(response) {
    ...
    let aliasKey = record.alias != null && record.alias.length > 0 ? _Key.default._fromProtobufKey(HieroProto.proto.Key.decode(record.alias)) : null;
    ...
    const contractFunctionResult = record.contractCallResult != null ? _ContractFunctionResult.default._fromProtobuf(record.contractCallResult, false) : record.contractCreateResult != null ? _ContractFunctionResult.default._fromProtobuf(record.contractCreateResult, true) : undefined;
    const newPendingAirdrops = record.newPendingAirdrops != null ? record.newPendingAirdrops.map(airdrop => _PendingAirdropRecord.default.fromBytes(airdrop)) : [];
    return new TransactionRecord({
      ...
      transactionId: _TransactionId.default._fromProtobuf(/** @type {HieroProto.proto.ITransactionID} */
      ...
      paidStakingRewards: record.paidStakingRewards != null ? _Transfer.default._fromProtobuf(record.paidStakingRewards) : [],
      prngBytes: record.prngBytes != null ? record.prngBytes : null,
      prngNumber: record.prngNumber != null ? record.prngNumber : null,
      evmAddress: record.evmAddress != null ? _EvmAddress.default.fromBytes(record.evmAddress) : null,
  ...
  static fromBytes(bytes) {
    return TransactionRecord._fromProtobuf(HieroProto.proto.TransactionGetRecordResponse.decode(bytes));
  }
   ...
   */
  toBytes() {
    return HieroProto.proto.TransactionGetRecordResponse.encode(this._toProtobuf()).finish();
  }
  ...
  toJSON() {
    return {
      ...
      tokenTransfersList: this.tokenTransfersList.map(transfer => transfer.toJSON()),
      ...
      ethereumHash: this.ethereumHash != null ? hex.encode(this.ethereumHash) : null,
      paidStakingRewards: this.paidStakingRewards,
      prngBytes: this.prngBytes != null ? hex.encode(this.prngBytes) : null,
