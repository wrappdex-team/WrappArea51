...
class ContractInfo {
  ...
  static _fromProtobuf(info) {
    ...
    /** @type {HieroProto.proto.IDuration} */info.autoRenewPeriod.seconds;
    return new ContractInfo({
      contractId: _ContractId.default._fromProtobuf(/** @type {HieroProto.proto.IContractID} */info.contractID),
      ...
      autoRenewAccountId: info.autoRenewAccountId != null ? _AccountId.default._fromProtobuf(info.autoRenewAccountId) : null,
