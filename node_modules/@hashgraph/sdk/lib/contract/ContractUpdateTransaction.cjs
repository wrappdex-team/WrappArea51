...
class ContractUpdateTransaction extends _Transaction.default {
  ...
  static _fromProtobuf(transactions, signedTransactions, transactionIds, nodeIds, bodies) {
    const body = bodies[0];
    const update = /** @type {HieroProto.proto.IContractUpdateTransactionBody} */
    ...
    if (update.memoWrapper != null && Object.hasOwn(update.memoWrapper, "value") && update.memoWrapper.value != null) {
    ...
    return _Transaction.default._fromProtobufTransactions(new ContractUpdateTransaction({
      contractId: update.contractID != null ? _ContractId.default._fromProtobuf(/** @type {HieroProto.proto.IContractID} */
      update.contractID) : undefined,
      bytecodeFileId: update.fileID != null ? _FileId.default._fromProtobuf(/** @type {HieroProto.proto.IFileID} */
      ...
      declineStakingReward: update.declineReward != null && Boolean(update.declineReward) == true,
      autoRenewAccountId: update.autoRenewAccountId != null ? _AccountId.default._fromProtobuf(update.autoRenewAccountId) : undefined
  ...
  clearAutoRenewAccountId() {
    this._autoRenewAccountId = new _AccountId.default(0);
    return this;
  }
...
_Transaction.TRANSACTION_REGISTRY.set("contractUpdateInstance",
