...
class ContractByteCodeQuery extends _Query.default {
  ...
  static _fromProtobuf(query) {
    const bytecode = /** @type {HieroProto.proto.IContractGetBytecodeQuery} */
  ...
  _mapResponseHeader(response) {
    const contractGetBytecodeResponse = /** @type {HieroProto.proto.IContractGetBytecodeResponse} */
    response.contractGetBytecodeResponse;
    return /** @type {HieroProto.proto.IResponseHeader} */contractGetBytecodeResponse.header;
  }
