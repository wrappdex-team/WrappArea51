...
class ContractExecuteTransaction extends _Transaction.default {
  ...
  static _fromProtobuf(transactions, signedTransactions, transactionIds, nodeIds, bodies) {
    const body = bodies[0];
    const call = /** @type {HieroProto.proto.IContractCallTransactionBody} */
    body.contractCall;
    return _Transaction.default._fromProtobufTransactions(new ContractExecuteTransaction({
      contractId: call.contractID != null ? _ContractId.default._fromProtobuf(/** @type {HieroProto.proto.IContractID} */
   ...
   * @returns {ContractExecuteTransaction}
   */
  setPayableAmount(amount, unit = _HbarUnit.default.Hbar) {
    this._requireNotFrozen();
    this._amount = amount instanceof _Hbar.default ? amount : _Hbar.default.from(amount, unit);
    return this;
  }
