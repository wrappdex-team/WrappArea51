...
class ContractInfoQuery extends _Query.default {
  ...
  _mapResponseHeader(response) {
    const contractGetInfo = /** @type {HieroProto.proto.IContractGetInfoResponse} */
    response.contractGetInfo;
    return /** @type {HieroProto.proto.IResponseHeader} */contractGetInfo.header;
  }
  ...
  _mapResponse(response, nodeAccountId, request) {
    ...
    response.contractGetInfo;
    return Promise.resolve(_ContractInfo.default._fromProtobuf(/** @type {HieroProto.proto.ContractGetInfoResponse.IContractInfo} */
    info.contractInfo));
  }
