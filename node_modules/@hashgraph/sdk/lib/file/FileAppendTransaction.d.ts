...
export default class FileAppendTransaction extends Transaction {
     ...
     * @returns {this}
     */
    freezeWith(client: Client | null): this;
    /**
     * @param {Client} client
     * @param {number=} requestTimeout
     * @returns {Promise<TransactionResponse>}
     */
    execute(client: Client, requestTimeout?: number | undefined): Promise<TransactionResponse>;
    /**
     * @param {Client} client
     * @param {number=} requestTimeout
     * @returns {Promise<TransactionResponse[]>}
     */
    executeAll(client: Client, requestTimeout?: number | undefined): Promise<TransactionResponse[]>;
    /**
     * @override
     * @protected
