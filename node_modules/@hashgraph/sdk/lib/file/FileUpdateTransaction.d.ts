...
export default class FileUpdateTransaction extends Transaction {
     ...
     */
    static _fromProtobuf(transactions: HieroProto.proto.ITransaction[], signedTransactions: HieroProto.proto.ISignedTransaction[], transactionIds: TransactionId[], nodeIds: AccountId[], bodies: HieroProto.proto.ITransactionBody[]): FileUpdateTransaction;
    /**
     * @param {object} props
    ...
    constructor(props?: {
        ...
        fileMemo?: string | null | undefined;
    });
    /**
     * @private
     * @type {?FileId}
     ...
     */
    protected override _makeTransactionData(): HieroProto.proto.IFileUpdateTransactionBody;
}
export namespace HieroProto {
    namespace proto {
        ...
        type IFileUpdateTransactionBody = import("@hiero-ledger/proto").proto.IFileUpdateTransactionBody;
    }
}
