...
class FileUpdateTransaction extends _Transaction.default {
  ...
  static _fromProtobuf(transactions, signedTransactions, transactionIds, nodeIds, bodies) {
    const body = bodies[0];
    const update = /** @type {HieroProto.proto.IFileUpdateTransactionBody} */
    body.fileUpdate;
    return _Transaction.default._fromProtobufTransactions(new FileUpdateTransaction({
      ...
      fileMemo: update.memo != null ? Object.hasOwn(update.memo, "value") ? update.memo.value : undefined : undefined
