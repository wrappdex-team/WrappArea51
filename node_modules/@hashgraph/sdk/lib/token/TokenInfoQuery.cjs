...
class TokenInfoQuery extends _Query.default {
  ...
  _mapResponseHeader(response) {
    const tokenGetInfo = /** @type {HieroProto.proto.ITokenGetInfoResponse} */
    response.tokenGetInfo;
    return /** @type {HieroProto.proto.IResponseHeader} */tokenGetInfo.header;
  }
  ...
  _mapResponse(response, nodeAccountId, request) {
    ...
    response.tokenGetInfo;
    return Promise.resolve(_TokenInfo.default._fromProtobuf(/** @type {HieroProto.proto.ITokenInfo} */info.tokenInfo));
  }
