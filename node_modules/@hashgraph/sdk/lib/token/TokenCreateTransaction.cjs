...
class TokenCreateTransaction extends _Transaction.default {
  ...
  constructor(props = {}) {
     ...
     * @type {?Timestamp}
     */
    this._expirationTime = new _Timestamp.default(Math.floor(Date.now() / 1000 + _Transaction.DEFAULT_AUTO_RENEW_PERIOD.toNumber()), 0);
  ...
  static _fromProtobuf(transactions, signedTransactions, transactionIds, nodeIds, bodies) {
    const body = bodies[0];
    const create = /** @type {HieroProto.proto.ITokenCreateTransactionBody} */
    body.tokenCreation;
    return _Transaction.default._fromProtobufTransactions(new TokenCreateTransaction({
      ...
      metadataKey: create.metadataKey != null ? _Key.default._fromProtobufKey(create.metadataKey) : undefined,
   ...
   */
  freezeWith(client) {
    if (!this._autoRenewAccountId && this.transactionId?.accountId && this.autoRenewPeriod != null) {
      this.setAutoRenewAccountId(this.transactionId?.accountId);
    } else if (!this._autoRenewAccountId && client?.operatorAccountId && this.autoRenewPeriod != null) {
...
_Transaction.TRANSACTION_REGISTRY.set("tokenCreation",
