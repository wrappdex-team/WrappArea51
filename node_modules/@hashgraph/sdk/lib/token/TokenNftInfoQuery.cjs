...
class TokenNftInfoQuery extends _Query.default {
  ...
  static _fromProtobuf(query) {
    if (query.tokenGetNftInfo != null) {
      ...
      const info = /** @type {HieroProto.proto.ITokenGetAccountNftInfosQuery} */
      ...
      const info = /** @type {HieroProto.proto.ITokenGetNftInfosQuery} */
  ...
  _mapResponse(response, nodeAccountId, request) {
    const nfts = [(/** @type {HieroProto.proto.ITokenNftInfo} */

    /** @type {HieroProto.proto.ITokenGetNftInfoResponse} */response.tokenGetNftInfo.nft)];
    return Promise.resolve(nfts.map(nft => _TokenNftInfo.default._fromProtobuf(/** @type {HieroProto.proto.ITokenNftInfo} */nft)));
  }
