...
export default class TokenDissociateTransaction extends Transaction {
     ...
     */
    static _fromProtobuf(transactions: HieroProto.proto.ITransaction[], signedTransactions: HieroProto.proto.ISignedTransaction[], transactionIds: TransactionId[], nodeIds: AccountId[], bodies: HieroProto.proto.ITransactionBody[]): TokenDissociateTransaction;
    /**
     * @param {object} [props]
     ...
     */
    protected override _makeTransactionData(): HieroProto.proto.ITokenDissociateTransactionBody;
}
