...
export default class TokenFreezeTransaction extends Transaction {
     ...
     */
    static _fromProtobuf(transactions: HieroProto.proto.ITransaction[], signedTransactions: HieroProto.proto.ISignedTransaction[], transactionIds: TransactionId[], nodeIds: AccountId[], bodies: HieroProto.proto.ITransactionBody[]): TokenFreezeTransaction;
    /**
     * @param {object} [props]
     ...
     */
    protected override _makeTransactionData(): HieroProto.proto.ITokenFreezeAccountTransactionBody;
}
