...
class TokenInfo {
  ...
  static _fromProtobuf(info) {
    const defaultFreezeStatus = /** @type {HieroProto.proto.TokenFreezeStatus} */
    info.defaultFreezeStatus;
    const defaultKycStatus = /** @type {HieroProto.proto.TokenKycStatus} */
    ...
    return new TokenInfo({
      tokenId: _TokenId.default._fromProtobuf(/** @type {HieroProto.proto.ITokenID} */info.tokenId),
      ...
      treasuryAccountId: info.treasury != null ? _AccountId.default._fromProtobuf(/** @type {HieroProto.proto.IAccountID} */
      info.treasury) : null,
      ...
      autoRenewPeriod: info.autoRenewPeriod != null ? _Duration.default._fromProtobuf(/** @type {HieroProto.proto.IDuration} */
      info.autoRenewPeriod) : null,
      expirationTime: info.expiry != null ? _Timestamp.default._fromProtobuf(/** @type {HieroProto.proto.ITimestamp} */
      info.expiry) : null,
      ...
      metadataKey: info.metadataKey != null ? _Key.default._fromProtobufKey(info.metadataKey) : null,
  ...
  _toProtobuf() {
    return {
      ...
      metadataKey: this.metadataKey != null ? this.metadataKey._toProtobufKey() : null,
  ...
  static fromBytes(bytes) {
    return TokenInfo._fromProtobuf(HieroProto.proto.TokenInfo.decode(bytes));
  }
