...
class TokenUpdateTransaction extends _Transaction.default {
  ...
  constructor(props = {}) {
     ...
     */
    this._keyVerificationMode = _TokenKeyValidation.default.FullValidation;
  ...
  static _fromProtobuf(transactions, signedTransactions, transactionIds, nodeIds, bodies) {
    const body = bodies[0];
    const update = /** @type {HieroProto.proto.ITokenUpdateTransactionBody} */
    body.tokenUpdate;
    return _Transaction.default._fromProtobufTransactions(new TokenUpdateTransaction({
      ...
      tokenName: Object.hasOwn(update, "name") ? update.name : undefined,
      tokenSymbol: Object.hasOwn(update, "symbol") ? update.symbol : undefined,
      ...
      tokenMemo: update.memo != null ? Object.hasOwn(update.memo, "value") ? update.memo.value : undefined : undefined,
      feeScheduleKey: update.feeScheduleKey != null ? _Key.default._fromProtobufKey(update.feeScheduleKey) : undefined,
      pauseKey: update.pauseKey != null ? _Key.default._fromProtobufKey(update.pauseKey) : undefined,
      metadataKey: update.metadataKey != null ? _Key.default._fromProtobufKey(update.metadataKey) : undefined,
      metadata: update.metadata != null ? Object.hasOwn(update.metadata, "value") ? update.metadata.value : undefined : undefined,
      keyVerificationMode: update.keyVerificationMode != null ? _TokenKeyValidation.default._fromCode(update.keyVerificationMode) : undefined
  ...
  _makeTransactionData() {
    return {
      ...
      metadataKey: this._metadataKey != null ? this._metadataKey._toProtobufKey() : null,
      metadata: this._metadata != null ? {
        value: this._metadata
      } : null,
      keyVerificationMode: this._keyVerificationMode != null ? this._keyVerificationMode._code : undefined
    };
  }
...
_Transaction.TRANSACTION_REGISTRY.set("tokenUpdate",
