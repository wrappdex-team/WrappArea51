...
export default class TokenUpdateTransaction extends Transaction {
     ...
     */
    static _fromProtobuf(transactions: HieroProto.proto.ITransaction[], signedTransactions: HieroProto.proto.ISignedTransaction[], transactionIds: TransactionId[], nodeIds: AccountId[], bodies: HieroProto.proto.ITransactionBody[]): TokenUpdateTransaction;
    /**
     * @param {object} [props]
    ...
    constructor(props?: {
        ...
        tokenMemo?: string | null | undefined;
        ...
        keyVerificationMode?: TokenKeyValidation | undefined;
    });
    /**
     * @private
     * @type {?TokenId}
     ...
     * @returns {this}
     */
    setMetadataKey(metadataKey: Key): this;
    /**
     * @returns {?Uint8Array}
     */
     ...
     */
    get keyVerificationMode(): TokenKeyValidation | null;
    /**
     * @param {TokenKeyValidation} keyVerificationMode
     * @returns {this}
     */
    setKeyVerificationMode(keyVerificationMode: TokenKeyValidation): this;
    /**
     * @returns {this}
     */
    clearTokenMemo(): this;
     ...
     */
    protected override _makeTransactionData(): HieroProto.proto.ITokenUpdateTransactionBody;
}
