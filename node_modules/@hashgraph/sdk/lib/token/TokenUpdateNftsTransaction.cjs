 ...
 */
class TokenUpdateNftsTransaction extends _Transaction.default {
  /**
   * @param {object} [props]
  ...
  static _fromProtobuf(transactions, signedTransactions, transactionIds, nodeIds, bodies) {
    ...
    return _Transaction.default._fromProtobufTransactions(new TokenUpdateNftsTransaction({
      ...
      metadata: tokenUpdate.metadata != null ? Object.hasOwn(tokenUpdate.metadata, "value") ? tokenUpdate.metadata.value : undefined : undefined
...
exports.default = TokenUpdateNftsTransaction;
