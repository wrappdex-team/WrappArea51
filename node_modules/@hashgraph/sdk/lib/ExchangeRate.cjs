...
class ExchangeRate {
  ...
  static _fromProtobuf(rate) {
    return new ExchangeRate({
      ...
      expirationTime: new Date(rate.expirationTime != null ? rate.expirationTime.seconds != null ? _long.default.isLong(rate.expirationTime.seconds) ? rate.expirationTime.seconds.toNumber() * 1000 : rate.expirationTime.seconds * 1000 : 0 : 0)
    });
  }
