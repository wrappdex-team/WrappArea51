...
export default class FreezeTransaction extends Transaction {
     ...
     */
    static _fromProtobuf(transactions: HieroProto.proto.ITransaction[], signedTransactions: HieroProto.proto.ISignedTransaction[], transactionIds: TransactionId[], nodeIds: AccountId[], bodies: HieroProto.proto.ITransactionBody[]): FreezeTransaction;
    /**
     * @param {object} [props]
    ...
    constructor(props?: {
        ...
        fileHash?: string | Uint8Array<ArrayBufferLike> | undefined;
     ...
     */
    protected override _makeTransactionData(): HieroProto.proto.IFreezeTransactionBody;
}
