...
export declare namespace IPermit2 {
    type PackedAllowanceStruct = {
        amount: BigNumberish;
        expiration: BigNumberish;
        nonce: BigNumberish;
    };
    type PackedAllowanceStructOutput = [
        amount: bigint,
        expiration: bigint,
        nonce: bigint
    ] & {
...
export interface IPermit2Interface extends Interface {
    getFunction(nameOrSignature: "allowance" | "permit" | "transferFrom"): FunctionFragment;
    encodeFunctionData(functionFragment: "allowance", values: [AddressLike, AddressLike, AddressLike]): string;
    encodeFunctionData(functionFragment: "permit", values: [AddressLike, IPermit2.PermitSingleStruct, BytesLike]): string;
