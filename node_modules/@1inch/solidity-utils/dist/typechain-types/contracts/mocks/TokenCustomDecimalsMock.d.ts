...
export interface TokenCustomDecimalsMock extends BaseContract {
    connect(runner?: ContractRunner | null): TokenCustomDecimalsMock;
    waitForDeployment(): Promise<this>;
    interface: TokenCustomDecimalsMockInterface;
