...
export interface ERC20ReturnTrueMockInterface extends Interface {
    getFunction(nameOrSignature: "allowance" | "approve" | "setAllowance" | "transfer" | "transferFrom"): FunctionFragment;
...
export interface ERC20ReturnTrueMock extends BaseContract {
    connect(runner?: ContractRunner | null): ERC20ReturnTrueMock;
