...
export interface ERC1271WalletMockInterface extends Interface {
    getFunction(nameOrSignature: "isValidSignature" | "owner" | "renounceOwnership" | "transferOwnership"): FunctionFragment;
...
export interface ERC1271WalletMock extends BaseContract {
    connect(runner?: ContractRunner | null): ERC1271WalletMock;
