...
export interface DaiLikePermitMockInterface extends Interface {
    getFunction(nameOrSignature: "DOMAIN_SEPARATOR" | "PERMIT_TYPEHASH" | "allowance" | "approve" | "balanceOf" | "decimals" | "eip712Domain" | "name" | "nonces" | "permit(address,address,uint256,uint256,bool,uint8,bytes32,bytes32)" | "permit(address,address,uint256,uint256,uint8,bytes32,bytes32)" | "symbol" | "totalSupply" | "transfer" | "transferFrom"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "permit(address,address,uint256,uint256,bool,uint8,bytes32,bytes32)", values: [
        AddressLike,
        AddressLike,
        BigNumberish,
        BigNumberish,
    ...
    decodeFunctionResult(functionFragment: "permit(address,address,uint256,uint256,bool,uint8,bytes32,bytes32)", data: BytesLike): Result;
...
export interface DaiLikePermitMock extends BaseContract {
    connect(runner?: ContractRunner | null): DaiLikePermitMock;
    waitForDeployment(): Promise<this>;
    interface: DaiLikePermitMockInterface;
    ...
    getFunction(nameOrSignature: "permit(address,address,uint256,uint256,bool,uint8,bytes32,bytes32)"): TypedContractMethod<[
        holder: AddressLike,
        spender: AddressLike,
        nonce: BigNumberish,
        expiry: BigNumberish,
