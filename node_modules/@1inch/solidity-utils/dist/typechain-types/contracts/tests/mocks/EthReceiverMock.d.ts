...
export interface EthReceiverMockInterface extends Interface {
}
export interface EthReceiverMock extends BaseContract {
    connect(runner?: ContractRunner | null): EthReceiverMock;
    waitForDeployment(): Promise<this>;
    interface: EthReceiverMockInterface;
