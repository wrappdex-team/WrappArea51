...
export interface AddressArrayInterface extends Interface {
}
export interface AddressArray extends BaseContract {
    connect(runner?: ContractRunner | null): AddressArray;
    waitForDeployment(): Promise<this>;
    interface: AddressArrayInterface;
