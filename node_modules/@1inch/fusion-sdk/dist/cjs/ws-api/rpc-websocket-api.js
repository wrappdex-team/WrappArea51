...
Object.defineProperty(exports, "RpcWebsocketApi", {
    enumerable: true,
    get: function() {
        return RpcWebsocketApi;
    }
});
var _pagination = require("../api/pagination.js");
...
var RpcWebsocketApi = /*#__PURE__*/ function() {
    "use strict";
    ...
    _create_class(RpcWebsocketApi, [
        ...
        },
        {
            ...
            value: function getActiveOrders() {
                ...
                var paginationRequest = new _pagination.PaginationRequest(page, limit);
