...
Object.defineProperty(exports, "FusionOrderParams", {
    enumerable: true,
    get: function() {
...
var FusionOrderParams = /*#__PURE__*/ function() {
    "use strict";
    function FusionOrderParams(params) {
        _class_call_check(this, FusionOrderParams);
        _define_property(this, "preset", _types.PresetEnum.fast);
        _define_property(this, "receiver", _limitordersdk.Address.ZERO_ADDRESS);
