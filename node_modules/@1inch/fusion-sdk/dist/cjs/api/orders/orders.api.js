    ...
    _create_class(OrdersApi, [
            ...
            value: function getActiveOrders(params, ordersVersion) {
                ...
                return _async_to_generator(function() {
                    ...
                    return _ts_generator(this, function(_state) {
                        ...
                        queryParams = (0, _params.concatQueryParams)(params.build(), ordersVersion);
            ...
            value: function getOrdersByMaker(params, ordersVersion) {
                ...
                return _async_to_generator(function() {
                    ...
                    return _ts_generator(this, function(_state) {
                        ...
                        qp = (0, _params.concatQueryParams)(params.buildQueryParams(), ordersVersion);
    ...
    ], [
        {
            ...
            value: function _new(config) {
                var httpClient = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : new _index.AxiosProviderConnector(config.authKey);
