...
export var LimitOrderWithFee = /*#__PURE__*/ function(LimitOrder) {
    "use strict";
    ...
    function LimitOrderWithFee(/**
         ...
         */ orderInfo) {
        var makerTraits = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : MakerTraits.default(), feeExtension = arguments.length > 2 ? arguments[2] : void 0;
     ...
     */ function getMakingAmount(taker) {
                ...
                var makingAmount = calcMakingAmount(takingAmount, this.makingAmount, this.takingAmount);
     ...
     */ function withRandomNonce(/**
         ...
         */ orderInfo, feeExtension) {
                var makerTraits = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : MakerTraits.default();
        ...
        },
        {
            ...
            value: function fromDataAndExtension(data, extension) {
                var makerTraits = new MakerTraits(BigInt(data.makerTraits));
                var feeExt = FeeTakerExtension.fromExtension(extension);
