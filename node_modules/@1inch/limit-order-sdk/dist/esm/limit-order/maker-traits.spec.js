...
describe('MakerTraits', function() {
    test('allowed sender', function() {
        var traits = MakerTraits.default();
        var sender = Address.fromBigInt(1337n);
    ...
    test('all', function() {
        var traits = MakerTraits.default().withAllowedSender(Address.fromBigInt(UINT_160_MAX)).allowPartialFills().allowMultipleFills().withEpoch(UINT_40_MAX, UINT_40_MAX).withExpiration(UINT_40_MAX).withExtension().enablePermit2().enableNativeUnwrap().enablePreInteraction().enablePostInteraction();
