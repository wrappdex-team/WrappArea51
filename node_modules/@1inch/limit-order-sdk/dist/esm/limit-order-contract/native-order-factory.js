...
import ABI from '../abi/NativeOrderFactory.abi.json' with {
    type: 'json'
};
...
export var NativeOrdersFactory = /*#__PURE__*/ function() {
    ...
    _create_class(NativeOrdersFactory, [
        ...
        {
            key: "default",
            value: function _default(chainId) {
                return new NativeOrdersFactory(new Address(getNativeOrderFactoryContract(chainId)));
            }
        }
    ]);
