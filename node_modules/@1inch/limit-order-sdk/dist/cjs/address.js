...
var Address = /*#__PURE__*/ function() {
    ...
    function Address(val) {
        ...
        (0, _assert.default)((0, _ethers.isAddress)(val), "Invalid address ".concat(val));
    ...
    _create_class(Address, [
        ...
        },
        {
            ...
            value: function lastHalf() {
                return (0, _byteutils.add0x)(this.val.slice(-20));
            }
        }
    ], [
        {
            ...
            value: function fromBigInt(val) {
                return new Address((0, _byteutils.add0x)(val.toString(16).padStart(40, '0')));
            }
        },
        {
            key: "fromFirstBytes",
