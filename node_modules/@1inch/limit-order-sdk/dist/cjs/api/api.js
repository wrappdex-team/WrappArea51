...
var Api = /*#__PURE__*/ function() {
     ...
     */ function getOrdersByMaker(maker, filters, /**
             ...
             */ sort) {
                return _async_to_generator(function() {
                    var _filters_statuses, _filters_makerAsset, _filters_takerAsset, pager, params;
                    return _ts_generator(this, function(_state) {
                        pager = (filters === null || filters === void 0 ? void 0 : filters.pager) || new _pager.CursorPager();
                        params = {
                        ...
                        return [
                            2,
                            this.httpClient.get(this.url("/address/".concat(maker), params), this.headers())
                        ];
                    });
                }).call(this);
            }
             ...
             */ sort) {
                return _async_to_generator(function() {
                    ...
                    return _ts_generator(this, function(_state) {
                        ...
                        return [
                            2,
                            this.httpClient.get(this.url("/all", params), this.headers())
                        ];
                    });
                }).call(this);
            }
     ...
     */ function getOrderByHash(hash) {
                return _async_to_generator(function() {
                    return _ts_generator(this, function(_state) {
                        return [
                            2,
                            this.httpClient.get(this.url("/order/".concat(hash)), this.headers())
                        ];
                    });
                }).call(this);
            }
     ...
     */ function getFeeParams(params) {
                return _async_to_generator(function() {
                    return _ts_generator(this, function(_state) {
                        return [
                            2,
                            this.httpClient.get(this.url("/fee-info", {
