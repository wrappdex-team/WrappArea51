...
var AmountMode = /*#__PURE__*/ function(AmountMode) {
    /**
 ...
 */ var TakerTraits = /*#__PURE__*/ function() {
    "use strict";
    function TakerTraits(flag, data) {
        ...
        this.flags = new _byteutils.BN(flag);
     ...
     */ function setInteraction(interaction) {
        ...
        },
        {
            ...
            value: function encode() {
                ...
                var extensionLen = this.extension ? (0, _byteutils.getBytesCount)(this.extension.encode()) : 0n;
                var interactionLen = this.interaction ? (0, _byteutils.getBytesCount)(this.interaction.encode()) : 0n;
                ...
                var args = (((_this_receiver = this.receiver) === null || _this_receiver === void 0 ? void 0 : _this_receiver.toString()) || _constants.ZX) + (0, _byteutils.trim0x)(((_this_extension = this.extension) === null || _this_extension === void 0 ? void 0 : _this_extension.encode()) || '') + (0, _byteutils.trim0x)(((_this_interaction = this.interaction) === null || _this_interaction === void 0 ? void 0 : _this_interaction.encode()) || '');
                return {
                    trait: flags.value,
                    args: args
                };
...
_define_property(TakerTraits, "THRESHOLD_MASK", new _byteutils.BitMask(0n, 185n));
_define_property(TakerTraits, "ARGS_INTERACTION_LENGTH_MASK", new _byteutils.BitMask(200n, 224n));
_define_property(TakerTraits, "ARGS_EXTENSION_LENGTH_MASK", new _byteutils.BitMask(224n, 248n));
