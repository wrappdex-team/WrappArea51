...
Object.defineProperty(exports, "FeeCalculator", {
    enumerable: true,
    get: function() {
...
var _muldiv = require("../../../utils/mul-div.js");
...
var FeeCalculator = /*#__PURE__*/ function() {
    "use strict";
    ...
    _create_class(FeeCalculator, [
        {
            ...
            value: function getTakingAmount(taker, orderTakingAmount) {
                ...
                return (0, _muldiv.mulDiv)(orderTakingAmount, _fees.Fees.BASE_1E5 + fees.resolverFee + fees.integratorFee, _fees.Fees.BASE_1E5, _muldiv.Rounding.Ceil);
            }
        },
        {
            key: "getMakingAmount",
            value: function getMakingAmount(taker, makingAmount) {
                var fees = this.getFeesForTaker(taker);
                return (0, _muldiv.mulDiv)(makingAmount, _fees.Fees.BASE_1E5, _fees.Fees.BASE_1E5 + fees.resolverFee + fees.integratorFee);
            }
        },
        {
            key: "getResolverFee",
     ...
     */ function getResolverFee(taker, orderTakingAmount) {
                ...
                var fees = this.getFeesForTaker(taker);
                return (0, _muldiv.mulDiv)(takingAmount, fees.resolverFee, _fees.Fees.BASE_1E5 + fees.resolverFee + fees.integratorFee);
            }
        },
        {
     ...
     */ function getIntegratorFee(taker, orderTakingAmount) {
                ...
                var takingAmount = this.getTakingAmount(taker, orderTakingAmount);
                var fees = this.getFeesForTaker(taker);
                var total = (0, _muldiv.mulDiv)(takingAmount, fees.integratorFee, _fees.Fees.BASE_1E5 + fees.resolverFee + fees.integratorFee);
                return (0, _muldiv.mulDiv)(total, BigInt(this.fees.integrator.share.toFraction(_fees.Fees.BASE_1E2)), _fees.Fees.BASE_1E2);
            }
        },
        {
     ...
     */ function getProtocolFee(taker, orderTakingAmount) {
        ...
        },
        {
            ...
            value: function getFeesForTaker(taker) {
                var discountNumerator = this.whitelist.isWhitelisted(taker) ? Number(_fees.Fees.BASE_1E2) - this.fees.resolver.whitelistDiscount.toFraction(_fees.Fees.BASE_1E2) : 100;
                var resolverFee = BigInt(discountNumerator * this.fees.resolver.fee.toFraction(_fees.Fees.BASE_1E5)) / _fees.Fees.BASE_1E2;
                var resolverFeeBN = BigInt(resolverFee);
                var integratorFeeBN = BigInt(this.fees.integrator.fee.toFraction(_fees.Fees.BASE_1E5));
                return {
