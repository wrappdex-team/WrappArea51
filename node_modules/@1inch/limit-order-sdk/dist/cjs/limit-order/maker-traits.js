...
Object.defineProperty(exports, "MakerTraits", {
    enumerable: true,
    get: function() {
        return MakerTraits;
    }
 ...
 * uint40 series
 */ var MakerTraits = /*#__PURE__*/ function() {
    "use strict";
    function MakerTraits(val) {
        _class_call_check(this, MakerTraits);
        _define_property(this, "value", void 0);
        this.value = new _byteutils.BN(val);
    }
     ...
     */ function allowedSender() {
        ...
        },
        {
            ...
            value: function withAllowedSender(sender) {
                (0, _assert.default)(!sender.isZero(), 'Use withAnySender() to remove sender check');
                var lastHalf = (0, _byteutils.add0x)(sender.toString().slice(-20));
     ...
     */ function isBitInvalidatorMode() {
        ...
        },
        {
            ...
            value: function enableEpochManagerCheck() {
                (0, _assert.default)(!this.isBitInvalidatorMode(), 'Epoch manager allowed only when partialFills and multipleFills enabled');
...
// Low 200 bits are used for allowed sender, expiration, nonceOrEpoch, and series
_define_property(MakerTraits, "ALLOWED_SENDER_MASK", new _byteutils.BitMask(0n, 80n));
_define_property(MakerTraits, "EXPIRATION_MASK", new _byteutils.BitMask(80n, 120n));
_define_property(MakerTraits, "NONCE_OR_EPOCH_MASK", new _byteutils.BitMask(120n, 160n));
_define_property(MakerTraits, "SERIES_MASK", new _byteutils.BitMask(160n, 200n));
