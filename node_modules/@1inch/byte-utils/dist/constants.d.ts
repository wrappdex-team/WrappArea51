export declare const UINT_8_MAX: bigint;
...
export declare const UINT_48_MAX: bigint;
export declare const UINT_64_MAX: bigint;
export declare const UINT_80_MAX: bigint;
export declare const UINT_96_MAX: bigint;
