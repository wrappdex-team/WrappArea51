...
export type QuoterRequestParams<SrcChain extends SupportedChain = SupportedChain, DstChain extends SupportedChain = SupportedChain> = {
    srcChain: SrcChain;
    dstChain: DstChain;
...
export type QuoterRequestParamsRaw<SrcChain extends SupportedChain = SupportedChain, DstChain extends SupportedChain = SupportedChain> = Omit<QuoterRequestParams<SrcChain, DstChain>, 'integratorFee'> & {
    fee?: number;
    feeReceiver?: string;
};
