...
import { ApiVersion, CustomPreset, IntegratorFeeRequest, PaginationOutput, PresetEnum } from '../api/index.js';
...
export type OrderCancellationData = PaginationOutput<SvmOrderCancellationData> | PaginationOutput<EvmOrderCancellationData>;
...
export type EvmOrderCancellationData<SrcChain extends EvmChain = EvmChain, DstChain extends SupportedChain = SupportedChain> = {
    orderHash: string;
    maker: EvmAddress;
    srcChainId: SrcChain;
    dstChainId: DstChain;
