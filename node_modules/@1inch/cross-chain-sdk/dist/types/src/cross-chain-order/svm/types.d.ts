...
export type OrderHashParams = Pick<SvmCrossChainOrder, 'hashLock' | 'maker' | 'makerAsset' | 'makingAmount' | 'srcSafetyDeposit' | 'timeLocks' | 'deadline' | 'srcAssetIsNative' | 'takingAmount' | 'resolverCancellationConfig' | 'multipleFillsAllowed' | 'salt'> & ({
    auction: AuctionDetails;
} | {
    auctionHash: Buffer;
});
