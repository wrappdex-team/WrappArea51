...
export declare enum EscrowEventSide {
    Src = "src",
    Dst = "dst"
}
export declare enum EscrowEventAction {
...
export type CancellableOrdersResponse = PaginationOutput<SvmCancellableOrderData> | PaginationOutput<EvmCancellableOrderData>;
export declare enum PublicAction {
    Withdraw = "withdraw",
    Cancel = "cancel"
}
