...
Object.defineProperty(exports, "AuctionDetails", {
    enumerable: true,
    get: function() {
...
var AuctionDetails = /*#__PURE__*/ function() {
    "use strict";
    function AuctionDetails(/**
        ...
        (0, _assert.default)(this.gasCost.gasBumpEstimate <= _constants.UINT_24_MAX);
        (0, _assert.default)(this.gasCost.gasPriceEstimate <= _constants.UINT_32_MAX);
        (0, _assert.default)(this.startTime <= _constants.UINT_32_MAX);
        (0, _assert.default)(this.duration <= _constants.UINT_24_MAX);
        (0, _assert.default)(this.initialRateBump <= _constants.UINT_24_MAX);
    }
     ...
     */ function encode() {
                var details = _ethers.ethers.solidityPacked([
                    'uint24',
                    'uint32',
                    'uint32',
                    'uint24',
                ...
                for(var i = 0; i < this.points.length; i++){
                    details += (0, _utils.trim0x)(_ethers.ethers.solidityPacked([
                        'uint24',
                        'uint16'
                    ], [
     ...
     */ function decode(data) {
                (0, _assert.default)((0, _validations.isHexBytes)(data), 'Invalid auction details data');
                var iter = _byteutils.BytesIter.BigInt(data);
        ...
        },
        {
            ...
            value: function fromExtension(extension) {
                return AuctionDetails.decode((0, _utils.add0x)(extension.makingAmountData.slice(42)));
            }
        }
    ]);
    return AuctionDetails;
