...
Object.defineProperty(exports, "WebSocketApi", {
    enumerable: true,
    get: function() {
        return WebSocketApi;
    }
});
var _activewebsocketordersapi = require("./active-websocket-orders-api.js");
var _rpcwebsocketapi = require("./rpc-websocket-api.js");
var _url = require("./url.js");
var _index = require("../connector/ws/index.js");
...
var WebSocketApi = /*#__PURE__*/ function() {
    ...
    function WebSocketApi(configOrProvider) {
        ...
        if (instanceOfWsApiConfigWithNetwork(configOrProvider)) {
            var url = (0, _url.castUrl)(configOrProvider.url);
            ...
            var provider = new _index.WebsocketClient(configWithUrl);
            this.provider = provider;
            this.rpc = new _rpcwebsocketapi.RpcWebsocketApi(provider);
            this.order = new _activewebsocketordersapi.ActiveOrdersWebSocketApi(provider);
            return;
        }
        this.provider = configOrProvider;
        this.rpc = new _rpcwebsocketapi.RpcWebsocketApi(configOrProvider);
        this.order = new _activewebsocketordersapi.ActiveOrdersWebSocketApi(configOrProvider);
    }
