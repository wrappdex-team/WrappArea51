...
Object.defineProperty(exports, "QuoterCustomPresetRequest", {
    enumerable: true,
    get: function() {
...
var QuoterCustomPresetRequest = /*#__PURE__*/ function() {
    "use strict";
    ...
    _create_class(QuoterCustomPresetRequest, [
        ...
        },
        {
            ...
            value: function validate() {
                if (!(0, _validations.isValidAmount)(this.customPreset.auctionStartAmount)) {
                    return 'Invalid auctionStartAmount';
                }
                if (!(0, _validations.isValidAmount)(this.customPreset.auctionEndAmount)) {
