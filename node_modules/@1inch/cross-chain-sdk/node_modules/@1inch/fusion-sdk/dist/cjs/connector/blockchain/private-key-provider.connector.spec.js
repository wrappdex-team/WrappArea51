...
var _privatekeyproviderconnector = require("./private-key-provider.connector.js");
...
describe('Private Key provider connector', function() {
    ...
    beforeEach(function() {
        ...
        privateKeyProviderConnector = new _privatekeyproviderconnector.PrivateKeyProviderConnector(testPrivateKey, (0, _tsmockito.instance)(web3Provider));
    });
