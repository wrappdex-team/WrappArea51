...
export function buildTakerTraits({ makingAmount = false, unwrapWeth = false, skipMakerPermit = false, usePermit2 = false, target = '0x', extension = '0x', interaction = '0x', threshold = BigInt(0), } = {}) {
    return {
        traits: BigInt(threshold) | ((makingAmount ? TakerTraitsConstants._MAKER_AMOUNT_FLAG : BigInt(0)) |
        ...
        args: solidityPacked(['bytes', 'bytes', 'bytes'], [target, extension, interaction]),
    };
}
//# sourceMappingURL=build-taker-traits.js.map