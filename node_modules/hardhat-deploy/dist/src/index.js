...
async function initCompanionNetworks(hre) {
    ...
    for (const name of Object.keys(hre.network.companionNetworks)) {
        ...
        if (networkName === hre.network.name) {
            ...
            const extraNetwork = {
                ...
                provider: plugins_2.lazyObject(() => hre.network.provider),
            };
        ...
        network.provider = await construction_1.createProvider(hre.config, networkName, hre.artifacts);
        const networkDeploymentsManager = new DeploymentsManager_1.DeploymentsManager(hre, network);
