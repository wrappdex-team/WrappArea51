...
const FALLBACK_HEDERA_TOKENS: HSuiteTokenInfo[] = [
  { id: "0.0.1456986", symbol: "WHBAR", name: "Wrapped HBAR", decimals: 8, priceUsd: 0, totalSupply: "50000000000000000", treasuryAccount: "0.0.98", verified: true },
  ...
  { id: "0.0.4291336", symbol: "USDT", name: "Tether", decimals: 6, priceUsd: 1.0, totalSupply: "500000000000", treasuryAccount: "0.0.4291336", verified: true },
  ...
  { id: "0.0.2283328", symbol: "KARATE", name: "Karate Combat", decimals: 8, priceUsd: 0.0012, totalSupply: "100000000000000000", treasuryAccount: "0.0.2283328", verified: true },
  { id: "0.0.4589822", symbol: "PACK", name: "HashPack", decimals: 6, priceUsd: 0.032, totalSupply: "5000000000000000", treasuryAccount: "0.0.4589822", verified: true },
  { id: "0.0.1159928", symbol: "HST", name: "HSuite Token", decimals: 8, priceUsd: 0.0023, totalSupply: "50000000000000000", treasuryAccount: "0.0.1159928", verified: true },
  { id: "0.0.6327456", symbol: "DOVU", name: "DOVU", decimals: 8, priceUsd: 0.0008, totalSupply: "100000000000000000", treasuryAccount: "0.0.6327456", verified: true },
  { id: "0.0.3155415", symbol: "GRELF", name: "Grelf", decimals: 8, priceUsd: 0.00001, totalSupply: "1000000000000000000", treasuryAccount: "0.0.3155415", verified: true },
];

const FALLBACK_SMART_POOLS: SmartPoolConfig[] = [
  {
    id: "sp-bluechip-1",
    name: "Hedera Blue Chip",
    strategy: "balanced",
    tokens: [
      { tokenId: "0.0.1456986", symbol: "WHBAR", name: "Wrapped HBAR", targetWeight: 40, currentWeight: 41.2, balance: "15000000000000", valueUsd: 420000, logo: "https://assets.coingecko.com/coins/images/3688/large/hbar.png" },
      { tokenId: "0.0.456858", symbol: "USDC", name: "USD Coin", targetWeight: 30, currentWeight: 28.8, balance: "300000000000", valueUsd: 300000, logo: "https://assets.coingecko.com/coins/images/6319/large/usdc.png" },
      { tokenId: "0.0.731861", symbol: "SAUCE", name: "SaucerSwap", targetWeight: 15, currentWeight: 16.1, balance: "3333333000000", valueUsd: 150000, logo: "" },
      { tokenId: "0.0.9356476", symbol: "HBAR.ħ", name: "HBAR.ħ Protocol", targetWeight: 15, currentWeight: 13.9, balance: "17284000000000", valueUsd: 140000, logo: "" },
    ],
  ...
  },
  {
    ...
    tokens: [
      ...
      { tokenId: "0.0.4291336", symbol: "USDT", name: "Tether", targetWeight: 50, currentWeight: 50.5, balance: "505000000000", valueUsd: 505000, logo: "https://assets.coingecko.com/coins/images/325/large/Tether.png" },
    ],
  ...
  },
  {
    ...
    strategy: "momentum",
    tokens: [
      { tokenId: "0.0.731861", symbol: "SAUCE", name: "SaucerSwap", targetWeight: 35, currentWeight: 38.2, balance: "7777777000000", valueUsd: 350000, logo: "" },
      { tokenId: "0.0.2283328", symbol: "KARATE", name: "Karate Combat", targetWeight: 25, currentWeight: 22.8, balance: "19166666000000", valueUsd: 230000, logo: "" },
      { tokenId: "0.0.4589822", symbol: "PACK", name: "HashPack", targetWeight: 20, currentWeight: 20.5, balance: "6406250000000", valueUsd: 205000, logo: "" },
      { tokenId: "0.0.1159928", symbol: "HST", name: "HSuite Token", targetWeight: 20, currentWeight: 18.5, balance: "80434782608695", valueUsd: 185000, logo: "" },
    ],
    rebalanceFrequency: "daily",
    ...
    totalValueLocked: 970000,
    totalShares: "970000000000",
    apr: 45.8,
    performanceFee: 5,
    managementFee: 1,
  ...
  },
  {
    ...
    tokens: [
      { tokenId: "0.0.1456986", symbol: "WHBAR", name: "Wrapped HBAR", targetWeight: 50, currentWeight: 52.1, balance: "18607142857142", valueUsd: 521000, logo: "https://assets.coingecko.com/coins/images/3688/large/hbar.png" },
      { tokenId: "0.0.9356476", symbol: "HBAR.ħ", name: "HBAR.ħ Protocol", targetWeight: 30, currentWeight: 27.9, balance: "34320987654320", valueUsd: 279000, logo: "" },
      { tokenId: "0.0.456858", symbol: "USDC", name: "USD Coin", targetWeight: 20, currentWeight: 20.0, balance: "200000000000", valueUsd: 200000, logo: "https://assets.coingecko.com/coins/images/6319/large/usdc.png" },
    ],
...
const FALLBACK_POOL_STATS: SmartPoolStats = {
  totalPools: 4,
  totalTvl: 3_985_000,
  totalVolume24h: 892_000,
  avgApr: 23.65,
  rebalancesLast24h: 12,
  topPerformer: { name: "DeFi Momentum", apr: 45.8 },
};
