...
const MESSAGES: Record<Lang, string> = {
  en:
    ...
    `When you hold WRAPpDEX tokens you are not just holding a speculative asset — you are holding a seat at the table, a vote in the DAO, a voice that actually gets heard, and a stake in a protocol that was designed from day one to put you first. ` +
  ...
  fr:
    ...
    `Quand vous detenez des tokens WRAPpDEX, vous ne detenez pas simplement un actif speculatif — vous detenez une place a la table, un vote dans le DAO, une voix qui est reellement entendue, et une participation dans un protocole concu des le premier jour pour vous placer en premier. ` +
  ...
  es:
    ...
    `Cuando tienen tokens WRAPpDEX no estan simplemente sosteniendo un activo especulativo — tienen un asiento en la mesa, un voto en el DAO, una voz que realmente se escucha, y una participacion en un protocolo disenado desde el primer dia para ponerlos a ustedes primero. ` +
